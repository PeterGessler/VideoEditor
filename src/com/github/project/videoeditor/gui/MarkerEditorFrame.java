...
public class MarkerEditorFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3689509405409685223L;
	...
	private MarkerEditorFrame() {
		...
		markerEditframeParent.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	private double deformatTime(String minutes, String seconds,
		...
		int inSeconds = (Integer.valueOf(minutes) * 60) + Integer.valueOf(seconds);
